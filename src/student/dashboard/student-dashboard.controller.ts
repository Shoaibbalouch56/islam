...
export class StudentDashboardController {
  ...
  getContinueLearning(
    ...
    return this.dashboardService.getContinueLearning(user.id, query);
  }

  @Get('featured-courses')
  getFeaturedCourses(@Query() query: DashboardListQueryDto) {
    return this.dashboardService.getFeaturedCourses(query);
  }
}
